...
sudo mkdir -p /usr/lib/python3/dist-packages/thingsboard_gateway/extensions/di
sudo cp ./custom_di_connector.py /usr/lib/python3/dist-packages/thingsboard_gateway/extensions/di
